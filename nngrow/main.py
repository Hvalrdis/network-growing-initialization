...
def _parser() -> argparse.ArgumentParser:
    ...
    # The selected model validates this count against integer widths, MHA head
    # partitions, and GradMax rank limits before dataset preparation.
    parser.add_argument(
        "--grow-steps",
        type=int,
        help="number of seed-to-target growth events; model limits are checked",
    )
