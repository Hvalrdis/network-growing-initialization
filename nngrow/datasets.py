...
def build_cvt_transforms():
    """Build the CIFAR transforms used by the reference VTs-Drloc pipeline."""
    try:
        from timm.data import create_transform
        from timm.data.constants import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
    except ImportError as error:
        raise RuntimeError(
            "CvT preprocessing requires timm; install requirements.txt before "
    ...
    train_transform.transforms[0] = transforms.RandomCrop(32, padding=4)
