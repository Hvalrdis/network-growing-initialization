...
from .models import cvt as model_cvt
from .models import mlp as model_mlp
from .models import vgg as model_vgg
from .models import vit as model_vit
from .models import wrn as model_wrn
