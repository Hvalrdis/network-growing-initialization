...
from ...experiment import PROJECT_ROOT, make_config, run_many
from .model import MODE_SPECS


ADAPTER = "unified_experiments.ablations.vit_growth_axis.model"
...
def _parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--grow-steps", type=int, default=12)
