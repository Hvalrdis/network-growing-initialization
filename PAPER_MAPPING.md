...
Entry point: `python3 -m unified_experiments.main`.
...
grow 12 times at intervals of 2,500 steps. Mode C is Row-Zero Initialization
with the `NZZ` block signature.
GradMax is included only for MLP, VGG, and WRN, as in the manuscript.

The CvT-13 preset uses the 100-epoch protocol reported in the manuscript.
