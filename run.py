...
TASKS = {
    "main": ("Main Tables 2-3", "unified_experiments.main"),
    "vit-axis": (
        "Appendix A / Table 4: Grow-d versus Grow-H",
        "unified_experiments.ablations.vit_growth_axis.main",
    ),
    "optimizer-state": (
        "Appendix B / Table 5: optimizer-state handling",
        "unified_experiments.ablations.optimizer_state.main",
    ),
}


def _usage() -> None:
    print("Usage: python3 -m unified_experiments <task> [task options]\n")
    print("Tasks:")
